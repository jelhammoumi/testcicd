...
/**
 * This file has been override to resolve multiselect "exclude/include selected" mechanism
 * @api
 */
define([
    'underscore',
    ...
    return Column.extend({
        ...
        */
        ...
        updateState: function () {
            ...
            } else if (totalRecords && totalRecords > 1 && selected === totalRecords && !this.preserveSelectionsOnFilter) {
                this.selectAll();
            }

            //custom : magento bug with excludeMode
            if (selected <= excluded || (excluded == 0)) {
                this.excludeMode(false);
            }
